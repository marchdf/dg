...
extern "C" void Lcpu_evaluate_sf_multifluid(int D, int N_G, int N_E, int N_F, scalar* s, scalar* f, scalar* Ug, scalar* dUg, scalar* invJac, scalar gamma);
extern "C" void Lcpu_evaluate_q_mhd(int M_G, int M_T, int N_F, scalar* q, scalar* UgF, scalar gamma, scalar* normals);
extern "C" void Lcpu_evaluate_q_multifluid(int M_G, int M_T, int N_F, scalar* q, scalar* UgF, scalar gamma);
