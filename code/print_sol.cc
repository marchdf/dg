...
//===========================================
void print_dg_multifluid(const int N_s, const int N_E, const int N_F, const fullMatrix<scalar> &U, const simpleMesh m, const int msh_lin, const int step, const double time, const int append, const int all, const scalar gamma){
  ...
  for (int e = 0; e < N_E; e++){
    for (int i = 0; i < N_s; i++){
      ...
      if((all==-1)||(all==3)) G  (i,e) = 0;
      if((all==-1)||(all==4)) P  (i,e) = (gamma-1)*(Et(i,e) - 0.5*Rho(i,e)*Ux(i,e)*Ux(i,e));
    }
  }
  // print to the output file
...
void print_dg_multifluid(const int N_s, const int N_E, const int N_F, scalar* U, const simpleMesh m, const int msh_lin, const int step, const double time, const int append, const int all, const scalar gamma){
