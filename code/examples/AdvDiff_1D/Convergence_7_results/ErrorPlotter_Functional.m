...
xlabel('$\tilde{h}$','Interpreter','LaTex')
ylabel('$E_{J}$','Interpreter','Latex')
title('Functional Error, $p=2$','Interpreter','Latex')
...
xlabel('$\tilde{h}$','Interpreter','LaTex')
ylabel('$E_{J}$','Interpreter','Latex')
title('Functional Error, $p=3$','Interpreter','Latex')
...
xlabel('$\tilde{h}$','Interpreter','LaTex')
ylabel('$E_{J}$','Interpreter','Latex')
title('Functional Error, $p=4$','Interpreter','Latex')
...
xlabel('$\tilde{h}$','Interpreter','LaTex')
ylabel('$E_{J}$','Interpreter','Latex')
title('Functional Error, $p=5$','Interpreter','Latex')
