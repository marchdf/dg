...
DATA = csvread('Convergence_7_Slim.csv');
eps = 10^(-16);
eJ_best = 1.0;

cJ = 7; %column for Cell-Average error
...
ylabel('$E_{CA}$','Interpreter','Latex')
title('Cell-Average Error, $p=1$','Interpreter','Latex')
...
xlabel('$\tilde{h}$','Interpreter','LaTex')
ylabel('$E_{CA}$','Interpreter','Latex')
title('Cell-Average Error, $p=2$','Interpreter','Latex')
...
xlabel('$\tilde{h}$','Interpreter','LaTex')
ylabel('$E_{CA}$','Interpreter','Latex')
title('Cell-Average Error, $p=3$','Interpreter','Latex')
...
xlabel('$\tilde{h}$','Interpreter','LaTex')
ylabel('$E_{CA}$','Interpreter','Latex')
title('Cell-Average Error, $p=4$','Interpreter','Latex')
...
xlabel('$\tilde{h}$','Interpreter','LaTex')
ylabel('$E_{CA}$','Interpreter','Latex')
title('Cell-Average Error, $p=5$','Interpreter','Latex')
